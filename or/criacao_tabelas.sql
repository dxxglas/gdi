...
CREATE TABLE postagem(
    ...
    CONSTRAINT postagem_membro_fk FOREIGN KEY (membro) REFERENCES membro(nome_de_usuario_m),
	CONSTRAINT postagem_moderador_fk FOREIGN KEY (moderador) REFERENCES moderador(nome_de_usuario_m)
);
...
CREATE TABLE denuncia(
	...
	postagem VARCHAR2(5),
	moderador VARCHAR2(8),
	CONSTRAINT denuncia_pk PRIMARY KEY (membro, postagem),
	CONSTRAINT denuncia_membro_fk FOREIGN KEY (membro) REFERENCES membro(nome_de_usuario_m),
    CONSTRAINT denuncia_postagem_fk FOREIGN KEY (postagem) REFERENCES postagem(id),
	CONSTRAINT denuncia_moderador_fk FOREIGN KEY (moderador) REFERENCES moderador(nome_de_usuario_m)
);
...
CREATE TABLE comentario(
	...
	descricao VARCHAR2(240),
	curtidas NUMBER,
	CONSTRAINT comentario_pk PRIMARY KEY (id_postagem, titulo),
