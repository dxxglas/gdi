...
--postagem
INSERT INTO postagem (id, membro, titulo, conteudo, exclusao, moderador) 
...
INSERT INTO postagem (id, membro, titulo, conteudo, exclusao, moderador) 
VALUES ('00014', 'grogu', 'Vídeo engraçado', 'Olhem esse vídeo de gatinho!!! youtube.com/video-gatinho', 1, 'gator7');
...
-- denuncia
INSERT INTO denuncia (membro, postagem, moderador)
VALUES ('ruyzinho', '00014', 'gator7');

--comentario
INSERT INTO comentario (titulo, id_postagem, descricao, curtidas)
VALUES ('Primeiro comentario', '00001', 'Que sonho estranho!', 0);

INSERT INTO comentario (titulo, id_postagem, descricao, curtidas)
VALUES ('Segundo comentario', '00001', 'Será que tem algum significado?', 0);

INSERT INTO comentario (titulo, id_postagem, descricao, curtidas)
VALUES ('Cheguei', '00013', 'Parabéns para ele!!', 0);

INSERT INTO comentario (titulo, id_postagem, descricao, curtidas)
VALUES ('Incrível', '00013', 'Que legal!!!', 1);
...
--pulbicar
INSERT INTO publicar (membro, postagem, categoria, data) 
VALUES ('bruno25', '00001', 2, to_date('11/02/2021', 'dd/mm/yyyy'));

INSERT INTO publicar (membro, postagem, categoria, data) 
VALUES ('leticiaV', '00012', 1, to_date('15/06/2021', 'dd/mm/yyyy'));

INSERT INTO publicar (membro, postagem, categoria, data) 
VALUES ('grogu', '00013', 3, to_date('08/07/2021', 'dd/mm/yyyy'));

INSERT INTO publicar (membro, postagem, categoria, data) 
VALUES ('grogu', '00014', 3, to_date('12/07/2021', 'dd/mm/yyyy'));

INSERT INTO publicar (membro, postagem, categoria, data) 
VALUES ('ruyzinho', '00015', 3, to_date('01/01/2021', 'dd/mm/yyyy'));


-- comentar
INSERT INTO comentar(postagem, membro, comentario, data)
VALUES ('00001', 'comments', '20015', to_date('11/02/2021', 'dd/mm/yyyy'));

INSERT INTO comentar(postagem, membro, comentario, data)
VALUES ('00001', 'comments', '20016', to_date('11/02/2021', 'dd/mm/yyyy'));

INSERT INTO comentar(postagem, membro, comentario, data)
VALUES ('00013', 'comments', '20020', to_date('08/07/2021', 'dd/mm/yyyy'));

INSERT INTO comentar(postagem, membro, comentario, data)
VALUES ('00013', 'ruyzinho', '20021', to_date('09/07/2021', 'dd/mm/yyyy'));